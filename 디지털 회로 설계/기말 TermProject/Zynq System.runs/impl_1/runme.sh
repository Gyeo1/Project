...
HD_PWD='C:/Users/Public/Zynq System/Zynq System.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_System_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_System_wrapper.tcl -notrace
