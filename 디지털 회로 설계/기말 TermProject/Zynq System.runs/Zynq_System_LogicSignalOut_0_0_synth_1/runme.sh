...
HD_PWD='C:/Users/Public/Zynq System/Zynq System.runs/Zynq_System_LogicSignalOut_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_System_LogicSignalOut_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_System_LogicSignalOut_0_0.tcl
