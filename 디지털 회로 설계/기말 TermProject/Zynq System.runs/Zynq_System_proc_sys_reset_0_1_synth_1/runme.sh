...
HD_PWD='C:/Users/Public/Zynq System/Zynq System.runs/Zynq_System_proc_sys_reset_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_System_proc_sys_reset_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_System_proc_sys_reset_0_1.tcl
