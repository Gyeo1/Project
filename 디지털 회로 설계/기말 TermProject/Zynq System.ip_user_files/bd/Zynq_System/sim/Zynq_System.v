...
(* CORE_GENERATION_INFO = "Zynq_System,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Zynq_System,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Zynq_System.hwdef" *) 
module Zynq_System
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [3:0]LogicSignalOut_0_common_digit;
  wire LogicSignalOut_0_led_out;
  wire [7:0]LogicSignalOut_0_logic_out;
  ...
  assign common_digit[3:0] = LogicSignalOut_0_common_digit;
  assign led_out = LogicSignalOut_0_led_out;
  assign logic_out[7:0] = LogicSignalOut_0_logic_out;
  Zynq_System_LogicSignalOut_0_0 LogicSignalOut_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .common_digit(LogicSignalOut_0_common_digit),
        .led_out(LogicSignalOut_0_led_out),
        .logic_out(LogicSignalOut_0_logic_out),
        .reset(proc_sys_reset_0_peripheral_aresetn));
  Zynq_System_proc_sys_reset_0_1 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
